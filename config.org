...
** org
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org
       ...
       :config
       ;; org files
       (defconst fn/org-directory (expand-file-name "~/Fakespace/nobody-library")
         "Main library for org files")

       (defconst fn/org-default-capture-file (expand-file-name "capture.org" fn/org-directory)
         "Main capture org file")

       (defconst fn/org-main-file (expand-file-name "main.org" fn/org-directory)
         "Main org planning file")

       (defconst fn/org-todo-file (expand-file-name "todo.org" fn/org-directory)
         "Main org todo file")

       (defconst fn/org-event-file (expand-file-name "event.org" fn/org-directory)
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package org-journal
        ...
        (setq org-journal-dir
              (expand-file-name "diary" fn/org-directory))
...
*** org-drill
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package org-drill
        ...
        (defconst fn/org-review-file (expand-file-name "learning.org" org-directory)
...
*** org-mobile
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package org-mobile
        :after org
        :config
        (defconst fn/org-mobile-directory (expand-file-name "mobile" fn/org-directory)
          "My org mobile directory")

        (defconst fn/org-mobile-inbox-directory (expand-file-name "mobile-pull" fn/org-directory)
          "My org mobile directory")
...
* Custom Bindings
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; Motion
    (global-set-key (kbd "C-!") (fn/trigger-key (kbd "C-<return>")))
    (global-set-key (kbd "M-!") (fn/trigger-key (kbd "M-<return>")))
