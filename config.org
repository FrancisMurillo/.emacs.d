...
* My Bindings
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; Motion
    (define-key global-map (kbd "C-` RET") (fn/trigger-key (kbd "C-<return>")))
    ;; (define-key global-map (kbd "M-` RET") (fn/trigger-key (kbd "M-<return>")))
    (define-key global-map (kbd "M-C-` RET") (fn/trigger-key (kbd "M-C-<return>")))
