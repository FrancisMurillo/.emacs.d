...
*** Theme
    Emacs theme for me. I prefer a bluish theme for the eyes since it's
    default doesn't ask too much.
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (unless (window-system) (load-theme 'base16-theme))
    #+END_SRC

*** Faces
    Some customization on the basic faces

    #+BEGIN_SRC emacs-lisp
      ;; Long lines with purple color is anonying
    #+END_SRC
...
*** paradox
    ...
    #+END_SRC
*** unicode-fonts
    Unicode is too much to pass up
