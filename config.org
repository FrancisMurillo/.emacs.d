    ...
    #+BEGIN_SRC emacs-lisp :block-id da802e8e-8302-f301-51f5-6042384a98a7
      (unless noninteractive
        (fn/use-feature flycheck-eslint-relative
          ...
          (defun fn/flycheck-eslint-enable ()
            "Enable `eslint' as flychecker."
            (add-to-list 'flychecker-enabled-checkers 'javascript-eslint))

          (add-to-list 'flycheck-checkers 'javascript-eslint)

          (add-hook 'js2-mode-hook #'fn/flycheck-eslint-enable)
