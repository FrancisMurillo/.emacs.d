     ...
     #+BEGIN_SRC emacs-lisp
       (use-feature helm-projectile
                    ...
                    (use-package helm-projectile
                      ...
                      (defun fn/uniquify-project-files (project-files &rest args)
                        "Customize how projectile files are displayed"
                        (lexical-let* ((swap-pair (lambda (pair)
                                                    (cons (cdr pair) (car pair))))
                                       (uniquifier (-compose
                                                    (-partial #'mapcar swap-pair)
                                                    #'f-uniquify-alist)))
                          (funcall uniquifier (apply project-files args))))

                      ;; (advice-add #'projectile-current-project-files :around  #'fn/uniquify-project-files)
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package magit
        ...
        (setq magit-inhibit-save-previous-winconf t
              magit-display-buffer-function #'fq/display-magit-on-same-buffer))
