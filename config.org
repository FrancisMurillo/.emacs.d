...
** eshell
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package eshell
       ...
       (add-hook 'eshell-pre-command-hook 'fn/eshell-rename-buffer-before-command)
       (add-hook 'eshell-post-command-hook 'fn/eshell-rename-buffer-after-command)
...
*** hungry-delete
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package hungry-delete
        ...
        :bind (("C-c n C-d C-d" . hungry-delete-forward)
               ("C-c n C-d DEL" . hungry-delete-backward)))
    #+END_SRC
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package golden-ratio
        ...
        (use-feature golden-window-numbering
                     ...
                     ;; This is my hack to combine window-numbering and golden-ratio
                     ;; On window selection, apply golden-ratio afterwards

                     (defun select-rationed-window-1 ()
                       "Select window number 1 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-1)
                       (golden-ratio))

                     (defun select-rationed-window-2 ()
                       "Select window number 2 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-2)
                       (golden-ratio))

                     (defun select-rationed-window-3 ()
                       "Select window number 3 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-3)
                       (golden-ratio))

                     (defun select-rationed-window-4 ()
                       "Select window number 4 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-4)
                       (golden-ratio))

                     (defun select-rationed-window-5 ()
                       "Select window number 5 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-5)
                       (golden-ratio))

                     (defun select-rationed-window-6 ()
                       "Select window number 6 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-6)
                       (golden-ratio))

                     (defun select-rationed-window-7 ()
                       "Select window number 7 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-7)
                       (golden-ratio))

                     (defun select-rationed-window-8 ()
                       "Select window number 8 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-8)
                       (golden-ratio))

                     (defun select-rationed-window-9 ()
                       "Select window number 9 and then apply golden-ratio to it"
                       (interactive)
                       (select-window-9)
                       (golden-ratio))

                     ;; NOTE: There must be a better way to compose key triggers
...
**** helm-projectile
     ...
     #+BEGIN_SRC emacs-lisp
       (defconst fn/helm-projectile-package-dir (expand-file-name "helm-projectile/" fn/custom-package-dir)
         "My custom helm projectile package")

       (use-feature helm-projectile
                    (projectile helm)
                    (use-package helm-projectile
                      :load-path fn/helm-projectile-package-dir
                      ...
                      ;; CUSTOM: Customized helm-projectile
                      (setq helm-source-projectile-projects--mapper #'fmc/uniquify-project-paths
                            helm-source-projectile-files--mapper #'fmc/uniquify-project-paths
                            helm-source-projectile-directories--mapper #'fmc/uniquify-project-paths)
...
** alert
   ...
   #+BEGIN_SRC emacs-lisp
     (defconst fn/alert-package-dir (expand-file-name "alert/" fn/custom-package-dir)
...
*** dumb-jump
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package dumb-jump
        :ensure t
        :bind (("C-c n C-d g" . dumb-jump-go)
               ("C-c n C-d b" . dumb-jump-back)))
    #+END_SRC
...
*** Mode
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (define-key emacs-lisp-mode-map (kbd "C-c m j") #'fn/find-definition-at-point)
    #+END_SRC
...
*** Mode
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      This somehow disregards SVN formatting in favor of the editor"
        ...
        (add-hook 'js2-jsx-mode-hook #'fn/indent-after-save nil t)
        (add-hook 'js2-jsx-mode-hook #'fn/indent-buffer nil t)
...
*** Formatter
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package jsfmt
        ...
        :after js2-mode
        :config
        (define-key js2-mode-map (kbd "C-c b b") #'jsfmt))
...
** starup and shutdown hook
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (define-key global-map (kbd "C-c m s") 'fn/startup)
     (define-key global-map (kbd "C-c m c") 'fn/cleanup)
   #+END_SRC
** Create media diary
...
* Key Bindings
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; Shell
    (global-set-key (kbd "C-c n x s") 'shell)
    ...
    (global-set-key (kbd "C-c m d f") #'fn/dired-fakespace-dir)

    (global-set-key (kbd "C-c m ^") #'fn/dired-parent)


    ;; Namer
    (global-set-key (kbd "C-c m v c") #'fmv/insert-camel-case)
    (global-set-key (kbd "C-c m v h") #'fmv/insert-hyphenated)
...
* Sandbox
  ...
  #+BEGIN_SRC emacs-lisp
    (defconst fn/elk-package-dir  (expand-file-name "elk" fn/custom-package-dir)
      "My elk package dir")
