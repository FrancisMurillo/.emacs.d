...
** jabber
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package jabber
       ...
       (log4e:deflogger "cbox" "%t: %m" "%H:%M:%S")
       (cbox--log-enable-logging)

       (defun fn/jabber-cbox-notify (from buffer text title)
         (cbox--log-info "Hey. %s pinged you." from)
         (cbox--log-open-log))

       (add-to-list 'jabber-alert-message-hooks #'fn/jabber-cbox-notify)
