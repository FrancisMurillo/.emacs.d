...
*** bookmark+
    ...
    #+BEGIN_SRC emacs-lisp :block-id 3165bffb-1127-0d5d-0a4f-7ff0b07d7612
      (defconst fn/bookmark+-dir (expand-file-name "bookmark+/" fn/custom-module-dir)
        "Archived `bookmark+' packages.")

      (unless noninteractive
        (use-package bookmark+
          :load-path fn/bookmark+-dir
          :defer t
          ;; :commands ()
          :config
          nil))
...
** list-processes+
   ...
   #+BEGIN_SRC emacs-lisp :block-id b627e0fd-bda7-5a5a-cec1-ecba55ba606d
     (defconst fn/list-processes+-dir (expand-file-name "list-processes+/" fn/custom-module-dir)
       "Archived `list-processes+' packages.")

     (use-package list-processes+
       :load-path fn/list-processes+-dir
       :defer t
       :bind (:map fn-standard-prefix-map
                   ("M-p" . list-processes+)))
   #+END_SRC
...
*** Project
    ...
    #+BEGIN_SRC emacs-lisp :block-id 08cd7439-df60-4b11-e8a1-17917ed8dd26
      ...
      (unless noninteractive
        (defconst fn/header2-dir (expand-file-name "header2/" fn/custom-module-dir)
          "Archived `header2' packages.")

        (use-package header2
          :load-path fn/header2-dir
          :demand t
