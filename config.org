     ...
     (fn/use-executables w3m-check
       ...
       (use-package w3m
         ...
         (fn/use-executables w3m-polipo-tor
           (w3m tor polipo)
           (defcustom fn/w3m-use-polipo-tor-proxy 'nothing
             "Check if a polipo proxy should be used.")

           (when (eq fn/w3m-use-polipo-tor-proxy
                     (default-value 'fn/w3m-use-polipo-tor-proxy))
             (setq fn/w3m-use-polipo-tor-proxy (yes-or-no-p "Use polipo and tor in browsing? ")))

           (when fn/w3m-use-polipo-tor-proxy
             (defconst fn/w3m-polipo-cache-dir (expand-file-name "polipo-cache" fn/cache-dir)
               "Polipo cache directory.")

             (defconst fn/w3m-tor-cache-dir (expand-file-name "tor-cache" fn/cache-dir)
               "Tor cache directory.")
             ...
             (defvar fn/w3m-tor-conf-file (expand-file-name "tor-w3m-conf" fn/cache-dir)
               "Tor configuration.")
