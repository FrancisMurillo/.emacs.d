                            ...
                            ((fn-separator "..")
                             ...
                             (pair-as-label (lambda (pairs)
                                              (lexical-let* ((labels
                                                             ...
                                                             ;; NOTE: Assumes the same window is used for Helm
                                                             (max-text-length
                                                              (window-text-width))
...
*** gnus-offlineimap
    ...
    #+BEGIN_SRC emacs-lisp
      (use-feature gnus-prodigy
                   (prodigy gnus)
                   (defconst fn/gnus-offlineimap-service-name "Offlineimap: Sync"
                     "My offlineimap syncer")

                   (prodigy-define-service
                     :name fn/gnus-offlineimap-service-name
                     :command "offlineimap"
                     :cwd "~")
                   ...
                   (add-hook 'gnus-before-startup-hook
                             (lambda ()
                               (prodigy-start-service
                                   (prodigy-find-service fn/gnus-offlineimap-service-name))))
