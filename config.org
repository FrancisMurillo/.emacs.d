...
** log4e
   ...
   #+BEGIN_SRC emacs-lisp :block-id e8344e55-09ff-27a8-a6c0-8d76e44cd3f0
     (use-package log4e
       ...
       (defconst fn/chat-server-name-face 'fn/chat-server-name-face
         "Chat team name face var")

       (defconst fn/chat-channel-name-face 'fn/chat-channel-name-face
         "Chat room name face var")

       (defconst fn/chat-chatter-name-face 'fn/chat-chatter-name-face
         "Chat sender name face var")

       (defconst fn/chat-message-face 'fn/chat-message-face
       ...
       (defun fn/chat-log (server channel chatter message)
         ...
         (unless (string-empty-p message)
           (let* ((out
                (string-trim-right
                 (format "[%s/%s] %s: %s"
                         (fn/chat-propertize (fn/prettify-word server) fn/chat-server-name-face)
                         (fn/chat-propertize (fn/prettify-word channel) fn/chat-channel-name-face)
