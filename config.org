   ...
   #+BEGIN_SRC emacs-lisp :block-id edb37fe1-f13c-60a5-6755-8fb7e6b5e2e6
     (use-package langtool
       ...
       (setq langtool-language-tool-jar
          (expand-file-name "languagetool-commandline.jar" "~/.local/lib/LanguageTool-3.6")
...
** w3m
   ...
   #+BEGIN_SRC emacs-lisp :block-id 4ef8aaa9-5b2f-30e3-c126-323935e0f9f6
     (use-package w3m
       ...
       (defvar fn/w3m-sumy--cache (make-hash-table :test 'equal)
         "A cache to store the results.")
