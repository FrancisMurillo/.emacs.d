...
** Request
   ...
   #+begin_src emacs-lisp :block-id 07553c47-e83a-a14e-db94-9ad3812fd926
...
** Local Variables
   ...
   #+begin_src emacs-lisp :block-id 23665247-784f-6b8d-a296-9a8b7c834fe6
...
** direnv
   ...
   #+begin_src emacs-lisp :block-id 324f145e-a402-abaa-dab0-26b5de87697f
...
**** Per-Project Config
     ...
     #+begin_src emacs-lisp :block-id 79cf3115-f556-78b5-c11f-d9da06e94c9f
...
*** org-tempo
    ...
    #+begin_src emacs-lisp :block-id 261bdcb6-74e9-a07a-3855-329a8ec7cfba
...
** Elixir
   ...
   #+begin_src emacs-lisp :block-id 626850b6-2af8-fdb6-0949-d4595523fff7
...
** Rust
   ...
   #+begin_src emacs-lisp :block-id 3461f079-e772-71d2-bdb2-ae1e84009f88
...
** Solidity
   ...
   #+begin_src emacs-lisp :block-id aec6aa60-e781-0b7e-3a98-5974f72cae6b
    ...
    #+BEGIN_SRC emacs-lisp :block-id 100731bb-4369-0570-8042-cf21a37b049c
      ...
      `fn/w3m-auto-bookmark-handler-functions'."
        ...
        (defun fn/w3m-auto-bookmark-arrived-url ()
          ...
          (when w3m-current-url ;; Check if url is not private
   ...
   #+begin_src emacs-lisp
     (unless noninteractive
       (use-package elfeed
         ...
         :defer t
         :config
         ;; Feeds are loaded externally

         (defconst fn/elfeed-db-dir (expand-file-name ".elfeed" fn/cache-dir)
           "Elfeed db dir")

         (setq elfeed-db-directory fn/elfeed-db-dir)
