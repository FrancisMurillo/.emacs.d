     ...
     (unless noninteractive
       (use-package mu4e
         ...
         (progn ;; Mail count
           ...
           (add-hook 'mu4e-view-mode-hook #'fn/mu4e-update-unread-message-count)
           (add-hook 'mu4e-index-updated-hook #'fn/mu4e-update-unread-message-count)
           (add-hook 'mu4e-msg-changed-hook #'fn/mu4e-update-unread-message-count))
