    ...
    #+BEGIN_SRC emacs-lisp
      (use-package prodigy
        ...
        (prodigy-define-service
          :name "sync-offline-imap"
          :command "offlineimap"
          :cwd "~")

        (add-hook 'gnus-before-startup-hook (lambda ()
                                              (prodigy-start-service (prodigy-find-service "sync-offline-imap"))))

        (add-hook 'gnus-exit-gnus  (lambda ()
                                     (prodigy-stop-service (prodigy-find-service "sync-offline-imap"))))
        )
    #+END_SRC
...
*** Literate Programming
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package fp/org-babel-js-setup
        ;; Pseudo package to setup org-babel with js2-mode
        :after (org js2-mode)
        :config
...
*** Prettify
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package prettify-haskell-symbols
