...
** org
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org
       ...
       (defconst fn/org-main-file (expand-file-name "main.org" org-directory)
         "Main org planning file")

       (defconst fn/org-todo-file (expand-file-name "todo.org" org-directory)
         "Main org todo file")

       (defconst fn/org-event-file (expand-file-name "event.org" org-directory)
