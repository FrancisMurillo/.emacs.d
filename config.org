       ...
       (defmacro fn/prodigy-with-default-filters (&rest body)
         `(fn/prodigy-with-buffer
           (let ((lexical-binding nil)
               (fn/prodigy-default-filters nil))
             ,@body
...
** Session Configurations
   ...
   #+BEGIN_SRC emacs-lisp
     (use-feature workgroup-configuration
       ...
       ;; Main macro config
       (defmacro fmwc/define-workgroup-configs (config-name setup-body cleanup-body)
       ...
       (use-feature workspace-prodigy
         (prodigy)
         (add-hook 'wg-before-switch-to-workgroup-hook #'fn/prodigy-clear-default-filterq)
