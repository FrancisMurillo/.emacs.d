...
*** workgroups
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package workgroups2
        ...
        ;; Load workgroups when all other configuration is done
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package projectile
        ...
        (defun fn/load-project-init ()
          ...
          (interactive)
          (let* ((project-init-file-name ".project.el")
                 (current-project-root (projectile-project-root))
                 (project-init-file (expand-file-name project-init-file-name current-project-root)))
        ...
        (add-hook 'projectile-after-switch-project-hook 'fn/load-project-init)
...
* My Bindings
  ...
  #+BEGIN_SRC emacs-lisp
    ;; Application
    (define-key global-map "\C-cx" 'helm-M-x)
    ;; Buffers
    (define-key global-map "\C-cnk" 'kill-this-buffer)

    ;; Custom Emacs
    (define-key global-map "\C-cmes" 'fn/bootstrap-spacemacs)
    (define-key global-map "\C-cmef" 'fn/bootstrap-from-dir)

    ;; Review Custom Emacs
    (define-key global-map "\C-cmep" 'fn/bootstrap-steve-purcell)
    (define-key global-map "\C-cmez" 'fn/bootstrap-zak-elep)
    (define-key global-map "\C-cmec" 'fn/bootstrap-sacha-chua)
    (define-key global-map "\C-cmej" 'fn/bootstrap-john-wiegley)
  #+END_SRC
