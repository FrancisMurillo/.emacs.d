...
** Coding
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (setq fn/enable-whitespace-cleanup-before-save t)

      (defun fn/delete-trailing-whitespace-before-save ()
        (when 'fn/enable-delete-whitespace-cleanup-before-save
...
*** projectile
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package projectile
        ...
        (add-hook 'projectile-after-switch-project-hook 'fn/load-project-hook)
...
*** tmtxt
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package tmtxt-dired-async
        ...
        (define-key-mode-map (kbd "C-c C-q") 'tda/download-to-current-dir)
