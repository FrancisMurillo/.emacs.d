...
**** emacs-tern-project-dialog
     A simple GUI to manage tern

     #+BEGIN_SRC emacs-lisp
       (defconst fn/widget-mvc-dir
         (expand-file-name "emacs-widget-mvc/" fn/custom-package-dir)
         "Custom wdiget-mvc dir")

       (use-package widget-mvc
         :load-path fn/widget-mvc-dir
         :after tern)


       (defconst fn/tern-project-dialog-dir
         (expand-file-name "emacs-tern-project-dialog/" fn/custom-package-dir)
         "Custom emacs-tern-project-dialog dir")

       (use-package tern-project-dialog
         :load-path fn/tern-project-dialog-dir
         :after widget-mvc)
     #+END_SRC
