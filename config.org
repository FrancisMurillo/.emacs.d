...
* Vanilla Emacs
  Basic configurations that I need for vanilla Emacs
...
** Environment
   ...
   #+BEGIN_SRC emacs-lisp :block-id e0adbf59-f7d8-f4c2-281d-4cabc523a47e
     ...
     ;; I don't need the customization group but might be useful keeping it around
     (setq custom-file (expand-file-name "custom-file.el" fn/cache-dir))
   #+END_SRC

** Garbage Collector
   Making the garbage collector more colorful and loose
   ...
   #+BEGIN_SRC emacs-lisp :block-id ad0dfafc-912b-1abc-12bb-fa6c5bbea607
     ...
     (use-package exec-path-from-shell
       ...
       (setq exec-path-from-shell-variables
             '("PATH" "MANPATH" "PROMPT" "PS1" "JAVA_HOME" "ECLIPSE_HOME")
...
** htmlize
   A custom =htmlize= library is required since code blocks are messed
   up when exporting for my blog. Hopefully this can be removed sometime
     ...
     (use-package all-the-icons
       ...
       (progn
         ...
         (fn/add-major-mode-icon
          'makefile-mode
          '(all-the-icons-faicon "wrench" :v-adjust -0.1))
         ...
         (fn/add-major-mode-icon
          'outline-mode
          '(all-the-icons-faicon "list-ul" :v-adjust -0.1))

         (fn/add-major-mode-icon
          'conf-unix-mode
          '(all-the-icons-faicon "code" :v-adjust -0.1))

         (fn/add-major-mode-icon
          'edmacro-mode
          '(all-the-icons-faicon "pause-circle" :v-adjust -0.1)))
...
* Libraries
  Libraries I wrote myself or copied mostly
...
** memory-usage
   Nice to know if my baby is getting too fat to quick
    ...
    #+BEGIN_SRC emacs-lisp :block-id 26aea11a-6b42-e3c0-dc5f-a8ba5ceb6f42
      (use-package yasnippet
        ...
        (setq yas-verbosity 3
              yas/root-directory (expand-file-name "snippets" fn/extra-dir)
...
*** uniquify
    ...
    #+BEGIN_SRC emacs-lisp :block-id 0daef306-f44a-5bc5-dead-1578ba3b8e9d
      (use-package uniquify
        :unless (or noninteractive (version<= emacs-version "24.3.1"))
        :demand t
        :config
...
**** Completion System
     Fix for the completion system being removed each time an upgrade is
     completed.

     #+BEGIN_SRC emacs-lisp :block-id 98315fa2-0cb4-6f9e-4ce6-e58001e1e45a
...
*** wanderlust
    ...
    #+BEGIN_SRC emacs-lisp :block-id 5cb8e831-3e7a-4919-a0cf-fa4b7361f621
...
*** ripgrep
    ...
    #+BEGIN_SRC emacs-lisp :block-id de06748b-2d12-d328-5f56-4d23d61b177f
      (unless noninteractive
...
*** TOML
    ...
    #+BEGIN_SRC emacs-lisp :block-id 475c10b4-bd99-cc34-0658-1aecf963b49a
...
*** GraphQL
    ...
    #+BEGIN_SRC emacs-lisp :block-id d41152e2-aa5a-bc66-2e4f-eaf8b4d9c2a6
...
*** Markdown
    ...
    #+BEGIN_SRC emacs-lisp :block-id 9f29863c-e970-6161-ca7f-96c383d1893f
...
*** EditorConfig
    ...
    #+BEGIN_SRC emacs-lisp :block-id 56b6bea0-b629-0a0d-52a3-990d009757b3
...
*** Thesaurus
    ...
    #+BEGIN_SRC emacs-lisp :block-id abd98313-2523-3476-e1e0-cad8fdb875d1
...
*** PlantUML
    ...
    #+BEGIN_SRC emacs-lisp :block-id d21de630-e067-119b-6961-49102cadb0aa
...
*** Literate Programming
    ...
    #+BEGIN_SRC emacs-lisp :block-id 52ced2ee-3888-35f1-e88b-2f3564b97a63
...
**** Haskell Process Load Fix
     ...
     #+BEGIN_SRC emacs-lisp :block-id 2c21cd5d-7397-9c9f-cedb-6cdfcb92ae2e
...
*** Mode
    ...
    #+BEGIN_SRC emacs-lisp :block-id f586336d-6a0d-4260-efea-5db7b72b7142
...
*** Linter
    ...
    #+BEGIN_SRC emacs-lisp :block-id f8cbb541-8fb2-2ddb-be99-eaa883f23e07
...
*** IDE
    ...
    #+BEGIN_SRC emacs-lisp :block-id fe9e4bdf-831e-b991-6727-4357f3083f60
      (use-package psc-ide
        :ensure t
...
** Rust
   A close C alternative

*** Mode
    Major mode for Rust

    #+BEGIN_SRC emacs-lisp :block-id 10bab1d8-1d69-5d81-e5ba-4c75dca5a291
...
*** Completion
    ...
    #+BEGIN_SRC emacs-lisp :block-id 9c0e8673-fae1-8385-7f86-b5fa2af4f2e1
      (use-package racer
        :ensure t
        :after company
...
*** Linter
    Integrate rust with flycheck

    #+BEGIN_SRC emacs-lisp :block-id c90a831d-97a8-bbef-0165-59740d87063e
...
*** Project Tooling
    ...
    #+BEGIN_SRC emacs-lisp :block-id 56dd4258-4b58-e797-2436-b03da0f81ae2
      (use-package cargo
        :ensure t
        :init
...
*** Linter
    ...
    #+BEGIN_SRC emacs-lisp :block-id 72aee93d-2dee-3827-4c54-663cafcb9f97
      (use-package rubocop
        :ensure t
        :init
...
*** Editing
    ...
    #+BEGIN_SRC emacs-lisp :block-id ba8a6b52-0db9-adf4-4f91-4f8757ae86d0
      (unless noninteractive
    ...
    #+BEGIN_SRC emacs-lisp :block-id 779d9b22-60a5-9956-ea14-8bba646238f0
      (use-package projectile-rails
        ...
        (add-to-list
         'display-buffer-alist
         (cons
          (rx bos "*projectile-rails-server*" eos)
          (cons 'display-buffer-same-window (list)))))
...
*** Mode
    ...
    #+BEGIN_SRC emacs-lisp :block-id c282d8b7-9fc9-feb6-bfd8-72df64ea9977
...
*** Linter
    ...
    #+BEGIN_SRC emacs-lisp :block-id b11a2210-cb08-a519-8aa7-f94211749548
...
*** Autocomplete
    ...
    #+BEGIN_SRC emacs-lisp :block-id dbec1ab5-6c00-627c-0520-73199854883b
...
*** COMMENT VLC Integration
    ...
    #+BEGIN_SRC emacs-lisp :block-id 2a94f5b0-ad91-2061-13ea-a693b18903fa
