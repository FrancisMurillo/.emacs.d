      ...
      (use-package prettify-symbols-mode
        ...
        (add-hook 'js2-mode-hook
                  (lambda ()
                    ...
                    (push '("false" . ?Θ) prettify-symbols-alist)
                    (push '("null" . ?Ν) prettify-symbols-alist)
                    (push '("undefined" . ?Χ) prettify-symbols-alist)
                    (push '(", ". ?ϵ) prettify-symbols-alist)
                    (push '("{". ?Ϲ) prettify-symbols-alist)
                    (push '("}". ?Ͻ) prettify-symbols-alist)
...
** Basic Modes
*** diminish
    Without this, the mode line has too many minor modes and I can't see
    the nyan cat
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package diminish
        :ensure t
        :config
        ;; TODO: Remove whitespace and visual -line
...
*** ace-window
    Changing windows is a common thing
