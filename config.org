   ...
   #+BEGIN_SRC emacs-lisp :block-id e3857d2d-0e50-e886-7186-cd58a7fd80ee
     ...
     (defvar fn/my-lightning (concat
                         (propertize "MY LIGHTNING"
                                     'face '(:background "#ff0000" :foreground "#000000"
                                                         :box (:line-width 0 :color "#ff0000")))
                         "...")
     ...
     (defvar fn/my-prayer (format "%s %s"
                             ...
                             (concat
                              (propertize "MY PRAYER"
                                          'face '(:background "#ffffff" :foreground "#000000"
           ...
           (let* ((out
                (string-trim-right
                 (format "[%s/%s] %s: %s"
                         ...
                         (fn/chat-propertize (fn/prettify-word channel) 'fn/chat-channel-nanme)
...
** camcorder
   ...
   #+BEGIN_SRC emacs-lisp :block-id 1ecfd02f-87eb-6c8a-0e20-68780b2e1e7b
     (use-package camcorder
       ...
       (advice-add 'camcorder-start :after  #'fn/camcorder-state-start)
       (advice-add 'camcorder-pause :before  #'fn/camcorder-state-pause)
       (advice-add 'camcorder-stop :after #'fn/camcorder-state-stop))
   #+END_SRC
