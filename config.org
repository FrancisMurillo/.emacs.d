...
** Window Layouts
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun fn/three-way-left-window-layout ()
       (interactive)
       (delete-other-windows)
       (split-window-horizontally)
       (other-window 1)
     ...
     (defun fn/three-way-vertical-window-layout ()
       (interactive)
       (delete-other-windows)
       (split-window-horizontally)
       )
...
* My Bindings
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (define-key global-map (kbd "C-c m w t") 'fn/three-way-left-window-layout)
